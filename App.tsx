...
const App: React.FC = () => {
  ...
  return (
    <div className="min-h-screen bg-poly-bg text-poly-text font-sans selection:bg-poly-blue selection:text-white pb-24 md:pb-20">
                ...
                <div className="flex gap-3">
                    <div className="relative flex-1">
                        ...
                        <input 
                            ...
                            className="w-full bg-poly-card border border-poly-hover text-white rounded-xl py-3 pl-10 pr-4 focus:outline-none focus:border-poly-blue focus:ring-1 focus:ring-poly-blue transition-all placeholder-poly-subtext"
                        />
                    </div>
                    <div className="relative">
                        ...
                        <select 
                             ...
                             className="appearance-none bg-poly-card border border-poly-hover text-white rounded-xl py-3 pl-10 pr-8 focus:outline-none focus:border-poly-blue cursor-pointer h-full font-medium"
                        >
      ...
      <div className="md:hidden fixed bottom-0 left-0 right-0 bg-poly-card/95 backdrop-blur-md border-t border-poly-hover pb-safe pt-2 px-6 flex justify-between z-50 h-16 shadow-[0_-4px_6px_-1px_rgba(0,0,0,0.1)]">
         <button 
